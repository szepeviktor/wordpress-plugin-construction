...
/* ]]> */';
    ...
    wp_enqueue_script( 'google_remarketing', 'https://www.googleadservices.com/pagead/conversion.js', array(), null, true );
    wp_add_inline_script( 'google_remarketing', $variables, 'before' );
}, 51 );
