...
function o1_nav_menu_meta_box_length( $meta_box_object ) {
    ...
    if ( property_exists( $meta_box_object, 'name' ) && in_array( $meta_box_object->name, $object_types ) ) {
        $per_page = defined( 'O1_NAV_MENU_METABOX_PER_PAGE' ) ? O1_NAV_MENU_METABOX_PER_PAGE : 200;
