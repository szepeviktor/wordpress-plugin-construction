...
add_filter( 'woocommerce_product_review_comment_form_args', 'wcprrt_print_comment_rating_hidden_field', 99 );
add_action( 'comment_post', 'wcprrt_add_comment_rating_hidden_field', 0 );

function wcprrt_print_comment_rating_hidden_field( $comment_form ) {
...
function wcprrt_add_comment_rating_hidden_field() {
